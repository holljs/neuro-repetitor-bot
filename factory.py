...
# ==========================================
TASKS_CONFIG = [
    {"topic": "topic_01_models", "pages": range(8, 31)},
    {"topic": "topic_02_calc",   "pages": range(31, 48)},
    {"topic": "topic_04_equations", "pages": range(50, 71)}, # Пример для 4-й темы
]
...
def smart_crop_and_stitch(topic, p1, p2=None):
    ...
    prompt = f"Найди все задачи на стр {p1}. Верни JSON список: " \
             "{'number': 'номер', 'box_2d': [ymin, xmin, ymax, xmax], 'needs_stitch': true/false}"

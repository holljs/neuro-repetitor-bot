...
async def check_answer_vision(request: CheckRequest):
    ...
    Твоя задача:
    1. Внимательно изучи картинку и текст задания.
    2. Пойми, к какому предмету оно относится, и реши задачу самостоятельно.
    3. Сравни свой правильный ответ с ответом ученика.

    ВЫДАЙ ОТВЕТ СТРОГО В ФОРМАТЕ JSON. Никакого текста до или после скобок {{ }}.
    Твой ответ должен выглядеть точно так:
    {{
      "is_correct": true (если ответ совпал) или false (если есть ошибка),
      "explanation": "Здесь напиши подробное пошаговое решение на русском языке. Обязательно напиши правильный ответ. Если ученик ошибся, объясни, в чем именно его ошибка и как нужно рассуждать."
    }}
    """
